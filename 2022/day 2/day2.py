with open("C:\\Users\\EC\\Downloads\\the maps\\vinegar\\knowledge-skill and trade\\adventofcode challenge\\2022\\day 2\\data.txt", "r") as file:
    map = file.read()
    A = map.split('\n') 
...
#rounds = [['A', 'Y'], ['B', 'X'], ['C', 'Z']] #example
rounds = B #actual data
